...
<link rel="icon"
	href="<c:url value="/resources/site-images/favicon.ico" />">
...
<!-- Bootstrap core CSS -->
<link
	href="<c:url value="/resources/js/bootstrap-3.3.7/css/bootstrap.min.css" />"
	rel="stylesheet">
...
<!-- Awesome Font CSS -->
<link
	href="<c:url value="/resources/js/font-awesome-4.7.0/css/font-awesome.min.css" />"
	rel="stylesheet">
					...
					<div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav pull-left">
							...
							<li><a href="<c:url value="/productos"/>"> <span
									class="glyphicon glyphicon-th-list"></span> Products on sale
							</a></li>
							<c:if
								...
								<li><a href="<c:url value="/customer/cart" />"> <span
										class="glyphicon glyphicon-shopping-cart"></span> Shopping
										cart
								</a></li>
							</c:if>
						</ul>
						<ul class="nav navbar-nav pull-right">
							...
							<c:if test="${pageContext.request.userPrincipal.name == null}">
								<li><a href="<c:url value="/registro" />"> <span
