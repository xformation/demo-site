...
public class CheckoutController {
	...
	public String saveBillingInfo(@RequestParam("Continue") String contnue,
			@ModelAttribute("orderDTO") OrderDTO order,
	...
	public String cancelCustomerInfo(@RequestParam("Cancel") int cancel) {
	...
	public String cancelShippingInfo() {
		return "checkout/checkOutCancelled";
	}
	...
	public String confirm(@ModelAttribute("orderDTO") OrderDTO order,
		...
		try {
			...
			result.addError(new ObjectError(ex.getMessage(), null));
